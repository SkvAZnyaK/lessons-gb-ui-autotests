    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "ru.gb.lesson");
                servletContext.setInitParameter("tapestry.development-modules", "ru.gb.lesson.services.DevelopmentModule");
